...
describe('MCP Utils', () => {
  ...
  describe('buildMCPResponse', () => {
    ...
    test('should handle empty metadata', () => {
      ...
      const result = buildMCPResponse(contextWithoutMeta, mockData, 'getWeather');
  ...
  describe('buildMCPErrorResponse', () => {
    test('should build error response', () => {
      ...
      const result = buildMCPErrorResponse(mockContext, errorMessage, 'getWeather');
    ...
    test('should handle multiple errors', () => {
      let result = buildMCPErrorResponse(mockContext, 'First error', 'endpoint1');
    ...
    test('should include timestamp in error', () => {
      const result = buildMCPErrorResponse(mockContext, 'Test error', 'getWeather');
